...
activities = {
    ...
    "Art Club": {
        "description": "Explore drawing, painting, and mixed media in a collaborative studio",
    ...
    "Debate Team": {
        "description": "Prepare and compete in local and regional debate tournaments",
